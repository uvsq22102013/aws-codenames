...
INSERT INTO "new_Partie" ("createurId", "dateCreation", "equipeEnCours", "equipeGagnante", "id", "indiceId", "langue", "pinHash", "roleEncours", "statut") SELECT "createurId", "dateCreation", "equipeEnCours", "equipeGagnante", "id", "indiceId", "langue", coalesce("pinHash", '') AS "pinHash", "roleEncours", "statut" FROM "Partie";
DROP TABLE "Partie";
